...
class Liquidador1_Form_eventos extends FormBase
{
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    $form['s0'] = [
      '#type' => 'markup',
      '#markup' => '<hr><p><div>Viabilidad para Realización de Eventos</div></p>',
    ];
   ...
   $form['valor_evento'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Valor Evento'),
      '#description' => 'Sin espacios. si puntos ni comas.',
      //'#required' => TRUE,
    ];
